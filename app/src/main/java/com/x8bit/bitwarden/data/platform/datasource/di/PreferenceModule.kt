...
object PreferenceModule {
    ...
    fun provideEncryptedSharedPreferences(
        ...
        try {
            ...
            destroySharedPreferencesAndRebuild(application = application)
     ...
     *
     * This not desirable and should only be called if we have completely failed to access our
     * shared preferences instance.
     */
    private fun destroySharedPreferencesAndRebuild(application: Application): SharedPreferences {
